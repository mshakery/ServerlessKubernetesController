...
const (
	Scheduler_Schedule_FullMethodName = "/kubernetes.Scheduler/Schedule"
)
...
type SchedulerClient interface {
	Schedule(ctx context.Context, in *PodDetail, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *schedulerClient) Schedule(ctx context.Context, in *PodDetail, opts ...grpc.CallOption) (*Empty, error) {
...
type SchedulerServer interface {
	Schedule(context.Context, *PodDetail) (*Empty, error)
...
func (UnimplementedSchedulerServer) Schedule(context.Context, *PodDetail) (*Empty, error) {
...
func _Scheduler_Schedule_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SchedulerServer).Schedule(ctx, req.(*PodDetail))
	}
