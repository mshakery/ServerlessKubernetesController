...
const (
	Authorization_Authorize_FullMethodName = "/kubernetes.Authorization/Authorize"
)
...
type AuthorizationClient interface {
	Authorize(ctx context.Context, in *AuthorizationRequest, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *authorizationClient) Authorize(ctx context.Context, in *AuthorizationRequest, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
	err := c.cc.Invoke(ctx, Authorization_Authorize_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthorizationServer interface {
	Authorize(context.Context, *AuthorizationRequest) (*Response, error)
...
func (UnimplementedAuthorizationServer) Authorize(context.Context, *AuthorizationRequest) (*Response, error) {
...
func _Authorization_Authorize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Authorization_Authorize_FullMethodName,
	}
...
var Authorization_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kubernetes.Authorization",
